...
mixin _$Worker {
 ...
 String get id; String get code; String get fullName; String get phone; String? get secondaryPhone; String get status; double? get latitude; double? get longitude; String? get locationReceivedAt; String get balance; String? get createdAt; String? get updatedAt; Collateral? get collateral; List<Collateral> get collaterals; String? get notes; String? get rejectedReason;
...
int get hashCode {
  final _this = this as Worker;
  return Object.hash(runtimeType,_this.id,_this.code,_this.fullName,_this.phone,_this.secondaryPhone,_this.status,_this.latitude,_this.longitude,_this.locationReceivedAt,_this.balance,_this.createdAt,_this.updatedAt,_this.collateral,const DeepCollectionEquality().hash(_this.collaterals),_this.notes,_this.rejectedReason);
}

@override
String toString() {
  final _this = this as Worker;
  return 'Worker(id: ${_this.id}, code: ${_this.code}, fullName: ${_this.fullName}, phone: ${_this.phone}, secondaryPhone: ${_this.secondaryPhone}, status: ${_this.status}, latitude: ${_this.latitude}, longitude: ${_this.longitude}, locationReceivedAt: ${_this.locationReceivedAt}, balance: ${_this.balance}, createdAt: ${_this.createdAt}, updatedAt: ${_this.updatedAt}, collateral: ${_this.collateral}, collaterals: ${_this.collaterals}, notes: ${_this.notes}, rejectedReason: ${_this.rejectedReason})';
}
...
@useResult
$Res call({
 String id, String code, String fullName, String phone, String? secondaryPhone, String status, double? latitude, double? longitude, String? locationReceivedAt, String balance, String? createdAt, String? updatedAt, Collateral? collateral, List<Collateral> collaterals, String? notes, String? rejectedReason
});
...
/// Create a copy of Worker
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? code = null,Object? fullName = null,Object? phone = null,Object? secondaryPhone = freezed,Object? status = null,Object? latitude = freezed,Object? longitude = freezed,Object? locationReceivedAt = freezed,Object? balance = null,Object? createdAt = freezed,Object? updatedAt = freezed,Object? collateral = freezed,Object? collaterals = null,Object? notes = freezed,Object? rejectedReason = freezed,}) {
  return _then(Worker(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String code,  String fullName,  String phone,  String? secondaryPhone,  String status,  double? latitude,  double? longitude,  String? locationReceivedAt,  String balance,  String? createdAt,  String? updatedAt,  Collateral? collateral,  List<Collateral> collaterals,  String? notes,  String? rejectedReason)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Worker() when $default != null:
return $default(_that.id,_that.code,_that.fullName,_that.phone,_that.secondaryPhone,_that.status,_that.latitude,_that.longitude,_that.locationReceivedAt,_that.balance,_that.createdAt,_that.updatedAt,_that.collateral,_that.collaterals,_that.notes,_that.rejectedReason);case _:
  return orElse();
...
@override
int get hashCode {
    return Object.hash(runtimeType,id,code,fullName,phone,secondaryPhone,status,latitude,longitude,locationReceivedAt,balance,createdAt,updatedAt,collateral,const DeepCollectionEquality().hash(_collaterals),notes,rejectedReason);
}

@override
String toString() {
    return 'Worker(id: $id, code: $code, fullName: $fullName, phone: $phone, secondaryPhone: $secondaryPhone, status: $status, latitude: $latitude, longitude: $longitude, locationReceivedAt: $locationReceivedAt, balance: $balance, createdAt: $createdAt, updatedAt: $updatedAt, collateral: $collateral, collaterals: $collaterals, notes: $notes, rejectedReason: $rejectedReason)';
}
...
/// Create a copy of Worker
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? code = null,Object? fullName = null,Object? phone = null,Object? secondaryPhone = freezed,Object? status = null,Object? latitude = freezed,Object? longitude = freezed,Object? locationReceivedAt = freezed,Object? balance = null,Object? createdAt = freezed,Object? updatedAt = freezed,Object? collateral = freezed,Object? collaterals = null,Object? notes = freezed,Object? rejectedReason = freezed,}) {
