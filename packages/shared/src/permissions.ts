...
export const PERMISSIONS = [
  'USER_VIEW_ALL', 'USER_CREATE', 'USER_UPDATE', 'USER_DEACTIVATE', 'PASSWORD_SET', 'ROLE_ASSIGN', 'PERMISSION_MANAGE',
...
const ADMIN_DEFAULTS: readonly Permission[] = [
  ...
  'CATALOG_VIEW', 'CATALOG_MANAGE', 'INVENTORY_VIEW', 'INVENTORY_MANAGE', 'MAP_VIEW_ALL', 'LIVE_LOCATION_VIEW_ALL', 'AUDIT_VIEW',
];
